                        ...
                        {selectedFeedback ? (
                            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-6">
                                ...
                                <a
                                    ...
                                    className="mt-4 w-full flex items-center justify-center gap-2 bg-black text-white py-3 rounded-lg font-medium hover:bg-gray-800 transition-colors"
                                >
                                ...
                                <button
                                    ...
                                    disabled={deleting}
                                    className="mt-3 w-full flex items-center justify-center gap-2 bg-red-500 text-white py-3 rounded-lg font-medium hover:bg-red-600 transition-colors disabled:opacity-50"
                                >
