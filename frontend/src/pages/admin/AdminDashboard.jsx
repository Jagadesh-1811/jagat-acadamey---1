...
import {
    FaArrowLeft, FaUsers, FaChalkboardTeacher, FaMoneyBillWave, FaBook,
    FaCommentDots, FaBug, FaSignOutAlt, FaSync, FaUserPlus, FaGraduationCap,
    FaClock, FaChartLine, FaUserGraduate
} from 'react-icons/fa';
import {
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 hover:shadow-md transition-shadow">
                        <div className="flex items-center gap-3">
                            <div className="w-12 h-12 bg-indigo-100 rounded-lg flex items-center justify-center">
                                <FaChalkboardTeacher className="w-6 h-6 text-indigo-600" />
                            </div>
                            <div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 hover:shadow-md transition-shadow">
                        <div className="flex items-center gap-3">
                            <div className="w-12 h-12 bg-emerald-100 rounded-lg flex items-center justify-center">
                                <FaUserPlus className="w-6 h-6 text-emerald-600" />
                            </div>
                            <div>
