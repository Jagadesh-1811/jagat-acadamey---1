...
import { FaRocket, FaGraduationCap, FaPlay, FaInfinity, FaCertificate, FaHeadset, FaLightbulb, FaHeart, FaUsers, FaChartLine, FaBookOpen, FaAward, FaStar, FaGlobe, FaShieldAlt, FaArrowRight } from 'react-icons/fa';
import { TbBrain, TbTargetArrow } from 'react-icons/tb';
import { HiSparkles, HiAcademicCap } from 'react-icons/hi2';
import { BsRocketTakeoff, BsLightningCharge } from 'react-icons/bs';
...
const About = () => {
    ...
    const stats = [
        { number: "100+", label: "Courses", icon: <FaBookOpen /> },
        { number: "50K+", label: "Learners", icon: <FaUsers /> },
        { number: "25+", label: "Expert Instructors", icon: <FaGraduationCap /> },
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                        {stats.map((stat, index) => (
                            <div
                                key={index}
                                className="group bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10 hover:border-blue-500/50 hover:bg-white/10 transition-all duration-500 text-center"
                            >
                        ...
                        <div className="relative">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <button
                                    ...
                                    className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-black font-semibold rounded-xl hover:bg-gray-100 transition-all duration-300 hover:scale-105 hover:shadow-xl"
                                >
                                    Explore Courses
                                    <FaArrowRight />
                                </button>
                                <button
                                    ...
                                    className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-blue-500 text-white font-semibold rounded-xl hover:bg-blue-600 transition-all duration-300 hover:scale-105 hover:shadow-xl"
                                >
                                    Get Started Free
                                    <HiSparkles />
                                </button>
