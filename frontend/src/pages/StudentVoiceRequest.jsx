    ...
    const fetchLiveRooms = async () => {
        try {
            ...
            if (rooms.length > previousLiveRoomCount && previousLiveRoomCount > 0) {
                toast.info('🔴 A new room is live! Join now to ask your doubts.', {
                    autoClose: 5000,
                    position: 'top-center'
                });
            }
        ...
        <>
            ...
            <div style={styles.container}>
                <div style={styles.header}>
                    <h1 style={styles.title}>🎙️ Voice Call with Educators</h1>
                ...
                <div style={{
                    ...
                    <span style={{ fontSize: '24px' }}>{isWeekend ? '✅' : '📅'}</span>
                ...
                {liveRooms.length > 0 && (
                    <div style={styles.liveRoomsSection}>
                        <h3 style={styles.sectionTitle}>🔴 Live Rooms - Join Now!</h3>
                                ...
                                <div key={room.roomId} style={styles.liveRoomCard}>
                                    <div style={styles.liveRoomHeader}>
                                        ...
                                        <span style={styles.participantBadge}>
                                            👥 {room.participantCount} {room.participantCount === 1 ? 'student' : 'students'}
                                        </span>
                                    </div>
                                    ...
                                    >
                                        {joiningRoomId === room.roomId ? 'Joining...' : '🎙️ Join Room'}
                                    </button>
                                </div>
                            ))}
                        </div>
                ...
                <div style={styles.educatorsSection}>
                    <h3 style={styles.sectionTitle}>📚 Your Educators</h3>
                                ...
                                <div key={educator._id} style={styles.educatorCard}>
                                    ...
                                    {educator.courses && educator.courses.length > 0 && (
                                        <div style={styles.coursesContainer}>
                                            <p style={styles.coursesLabel}>📚 Courses:</p>
