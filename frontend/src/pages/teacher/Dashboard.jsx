            ...
            <div className="w-full px-6 py-10   bg-gray-50 space-y-10">
                ...
                <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-md p-6 flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div className="text-center md:text-left space-y-1">
                        ...
                        <h1 className='px-[10px] text-center  py-[10px] border-2  bg-white border-black text-black  rounded-[10px] text-[15px] font-light flex items-center justify-center gap-2 cursor-pointer mt-2' onClick={() => navigate("/admin/feedback-manager")}>View Feedback & Issues</h1>
                    </div>
                </div>
